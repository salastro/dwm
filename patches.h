...
/* This patch adds an indicator to the window title for sticky windows. The
 * indicator is a (S) by default. This patch depends on the sticky patch and flexwintitle.
 */
